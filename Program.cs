...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            Console.WriteLine("\n\rAge and Physical descriptions fields are complete for all ours friedn.");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 0] != "ID #: " && ourAnimals[i, 5] == "Personality: ")
                {
                    do
                    {
                        Console.WriteLine($"Enter a personality description for {ourAnimals[i, 0]} (like or dislike, tricks, energy level)");
                        readResult = Console.ReadLine();
                        if (readResult != null)
                        {
                            animalPersonalityDescription = readResult.ToLower();
            ...
            Console.WriteLine("\n\rNickname and personality description fields are complete for all ours friedn.\n\rPress the enter key to continue");
            readResult = Console.ReadLine();
            break;
